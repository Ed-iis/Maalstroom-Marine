...
class MainActivity : AppCompatActivity() {
    companion object { private const val UDP_PORT = 10110; private const val MAX_PACKET_SIZE = 65_535 }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(webView); acquireWakeLock(); startUdpReceiver()
    }

    override fun onDestroy() { stopUdpReceiver(); wakeLock?.let { if (it.isHeld) it.release() }; webView.destroy(); super.onDestroy() }
